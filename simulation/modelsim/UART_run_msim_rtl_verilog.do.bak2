...
vlog -vlog01compat -work work +incdir+F:/New\ folder\ (2) {F:/New folder (2)/UART_Module.v}
vlog -vlog01compat -work work +incdir+F:/New\ folder\ (2) {F:/New folder (2)/UART_TX.v}
vlog -vlog01compat -work work +incdir+F:/New\ folder\ (2) {F:/New folder (2)/UART_RX.v}
vlog -vlog01compat -work work +incdir+F:/New\ folder\ (2) {F:/New folder (2)/UART_tb.v}
